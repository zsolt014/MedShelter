...
const residents = [
  {
    ...
    buletinNumber:'HR 123456', buletinExpiry:'2026.08.15',
    medications:[
    ...
    letters:[
      { id:1, specialty:'Kardiológia', doctor:'Dr. Popescu', valid:'2026.11.15' },
      { id:2, specialty:'Neurológia', doctor:'Dr. Farkas', valid:'2026.08.10' }
    ]
  },
  {
    id:2, name:'Márk Zsolt', room:'8', doctor:'Dr. Török', status:'Aktív',
    birthDate:'1975.11.02', taj:'234-567-891', phone:'—', notes:'',
    buletinNumber:'HR 234567', buletinExpiry:'2026.09.10',
    medications:[
      { id:3, name:'Teotard', dosage:'1-0-0', qty:30, last:'2026.08.15', next:'2026.09.15' }
    ],
    letters:[
      { id:3, specialty:'Pszichiátria', doctor:'Dr. Radu', valid:'2026.09.01' }
    ]
  },
  {
    ...
    buletinNumber:'HR 345678', buletinExpiry:'2027.01.20',
    medications:[
